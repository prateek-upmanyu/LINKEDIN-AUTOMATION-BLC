...
export async function GET() {
  ...
  // Scopes supporting both Personal profile and Company/Business Page posting
  const scope = 'w_organization_social r_organization_social w_member_social profile email openid';
